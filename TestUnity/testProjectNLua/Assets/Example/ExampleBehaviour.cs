...
*/
    ...
    public void ResetLua()
    {
        env = new Lua();
        env.LoadCLRPackage();
        source = File.ReadAllText(@"/school/troep/testProjectNLua/Assets/BehaviourLua.lua");
        stringToEdit = File.ReadAllText(@"/school/troep/testProjectNLua/Assets/BehaviourLua.lua");
    ...
    public void CreateNewClass(string className = "Test")
    {
        if(!File.Exists(@"/school/troep/testProjectNLua/Assets/Example/" + className + ".cs"))
        {
            File.Create(@"/school/troep/testProjectNLua/Assets/Example/" + className + ".cs");
            //File.WriteAllText(@"/school/troep/testProjectNLua/Assets/Example/" + className + ".cs", CreateNewClassString(className));
        }
        else
        {
            //File.WriteAllText(@"/school/troep/testProjectNLua/Assets/Example/" + className + ".cs", CreateNewClassString(className));
    ...
    public void SaveLua()
    {
        File.WriteAllText(@"/school/troep/testProjectNLua/Assets/BehaviourLua.lua", "");
        File.WriteAllText(@"/school/troep/testProjectNLua/Assets/BehaviourLua.lua", stringToEdit);
        ResetLua();
    }
    public string CreateNewClassString(string pClassName)
    {
        return @"
                using UnityEngine;
                using System;

                public class "+pClassName+@" : MonoBehaviour
                {
                    //Update Loop
                    void Update()
                    {
