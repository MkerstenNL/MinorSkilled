...
function OnHit (Hit)
	...
	if(Hit == "Door") then
	M.Message("Try opening the door by typing Door:Open()",1)
	end
	...
	M.Message("Tip:Coin.PickUp()",1)
	end
	if(Hit == "TriggerPickedUpCoin") then
	M.Message("Nice you have some money now and again you used a function but for another object. Let's continue.",0)
	end
